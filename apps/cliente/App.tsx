...
export default function App(){
  ...
  const ordersView=<ScrollView contentContainerStyle={styles.scroll}>
    ...
    {tracking&&trackedOrder&&<View style={styles.trackingCard}>
      ...
      <Text style={styles.trackingKicker}>ACOMPANHAMENTO EM TEMPO REAL</Text><Text style={styles.trackingTitle}>Pedido #{trackedOrder.order_number}</Text><Text style={styles.trackingStatus}>{statusLabel[trackedOrder.status]??trackedOrder.status}</Text><OrderProgress status={trackedOrder.status}/>
