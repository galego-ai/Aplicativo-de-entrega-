  ...
  return (
    <main className="app">
      ...
      <aside className="side">
        ...
        <nav>{tabs.map((item) => <button key={item} onClick={() => setTab(item)} className={tab === item ? "active" : ""}>{item}</button>)}</nav><a href="/avaliacoes" style={{display:"block",margin:"10px 0",padding:"12px 14px",borderRadius:10,background:"#111",color:"#f4c400",fontWeight:900,textDecoration:"none",textAlign:"center"}}>Avaliações dos clientes</a><a href="/entregadores" style={{display:"block",margin:"10px 0",padding:"12px 14px",borderRadius:10,background:"#f4c400",color:"#111",fontWeight:900,textDecoration:"none",textAlign:"center"}}>Atribuir entregador</a><a href="/recibos" style={{display:"block",margin:"10px 0",padding:"12px 14px",borderRadius:10,background:"#fff",border:"1px solid #d8d8d8",color:"#111",fontWeight:900,textDecoration:"none",textAlign:"center"}}>Recibos / imprimir</a>
      </aside>
